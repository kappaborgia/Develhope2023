...
public class Main {
    public static void main(String[] args) {
        TipoForma[] disegnaForma = {TipoForma.CERCHIO, TipoForma.QUADRATO, TipoForma.RETTANGOLO, TipoForma.TRIANGOLO};

        for(TipoForma tipoForma : disegnaForma){
            Forma forma = FormaFactory.creaForma(tipoForma);
            forma.Disegna();
